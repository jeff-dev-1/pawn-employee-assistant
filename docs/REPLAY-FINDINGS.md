...
copied from `main`. Twenty-seven places where the prompts and this repository disagreed came out of it —
...
and one from asking the gateway what it actually does instead of reading the answer text. All of
